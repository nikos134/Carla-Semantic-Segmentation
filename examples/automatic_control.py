...
try:
    sys.path.append(glob.glob('../PythonAPI/carla/agents')[0])
except IndexError:
    print("agents package wasn't found")
import carla
from carla import ColorConverter as cc
from PythonAPI.carla.agents.navigation.roaming_agent import RoamingAgent
